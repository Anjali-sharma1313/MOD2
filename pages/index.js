...
export default function Homepage() {
    ...
    const [meMessage,setMeMessage] = useState("Beneficiary's Name : Anjali Sharma ");
    ...
    const initUser = () => {
        ...
        return (
            <div>
                ...
                <button onClick={DisplayAddress}><h3 >Owner's Address</h3></button>
                <button onClick={deposit}><h3 >increase 1 ETH</h3></button>
                <button onClick={withdraw}><h3>decrease 1 ETH</h3></button>
                <button onClick={TransferFunds}><h3>MoveFunds 1 ETH</h3></button>
            </div>
        )
    }
    ...
    return (
      <main className="anjali">
        <h1><marquee width="60%" direction="left" height="80%">Anjali's Smart Contract Management!</marquee></h1>
        <h2>{meMessage}</h2>
        {initUser()}
        <style jsx>{`
            .anjali {
